...
public class PhoneWindowManager implements WindowManagerPolicy {
	...
	static void longcosinjectKeyEvent(long time, int action, int keycode, int repeat) {
            ...
            switch (mShortPressOnPowerBehavior) {
                ...
                case SHORT_PRESS_POWER_GO_TO_SLEEP:
					try{
				   	   ...
				   	   if (DEBUG_WAKEUP) Slog.i("KEYCODE_POWER","lgw is not com.toycloud.watch.launcher"); 					   
					   final long downTime = SystemClock.uptimeMillis();
					   
					   longcosinjectKeyEvent(downTime, KeyEvent.ACTION_DOWN, KeyEvent.KEYCODE_BACK, 0);
					   
					   final long upTime   = SystemClock.uptimeMillis();
					   
					  
					   longcosinjectKeyEvent(upTime, KeyEvent.ACTION_UP, KeyEvent.KEYCODE_BACK, 0);
